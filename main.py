...
if __name__ == '__main__':
    ...
    try:
        github_data = request_client.get("https://github.com/termedxml?tab=projects").json()
 ...
 _____                            _          _     _
|_   _|__ _ __ _ __ ___   ___  __| |_      _| |__ | |_ __ ___
  | |/ _ \ '__| '_ ` _ \ / _ \/ _` \ \ /\ / / '_ \| | '_ ` _ \
  | |  __/ |  | | | | | |  __/ (_| |\ V  V /| |_) | | | | | | |
  |_|\___|_|  |_| |_| |_|\___|\__,_(_)_/\_/ |_.__/|_|_| |_| |_|

 _                _                  _              _
| |__   __ _  ___| | ___   _ _ __   | |_ ___   ___ | |
| '_ \ / _` |/ __| |/ / | | | '_ \  | __/ _ \ / _ \| |
| |_) | (_| | (__|   <| |_| | |_) | | || (_) | (_) | |
|_.__/ \__,_|\___|_|\_\\__,_| .__/   \__\___/ \___/|_| {colours['white']}
root$> Made with sum {colours['main_colour']}<3{colours['white']} by {colours['main_colour']}termed.wblm Project{colours['white']}
root$> Github: {colours['main_colour']}https://github.com/termedxml{colours['white']}
root$> Version: {colours['main_colour']}{app_version}{colours['white']}
root$> Discord Build: {colours['main_colour']}{colours['main_colour']}{discord_build}{colours['white']}{'' if not discord_build_failback else ' (failback)'}""")
...
{colours['light_blue']}>{colours['white']} Choice ({colours['main_colour']}int{colours['white']}) """, end="")
        ...
        if choice == 1:
            ...
            c.info('Go to: http://github.com/termedxml?tab=projects')
            c.info('For additional help, join the Discord Server: https://discord.gg/2ekQJDm3kB')
